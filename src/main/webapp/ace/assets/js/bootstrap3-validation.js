...
!function($) {
   ...
   $.fn.validation.defaults = {
        validRules : [
            ...
            {name: 'requiredSelect', validate: function(value) {return ($.trim(value) == '');}, defaultMsg: '请选择选项'},
            ...
            {name: 'loginName', validate: function(value) {return (!/^(?!_+$)(?!\d+$)[a-zA-Z\d_]{4,25}$/.test(value));}, defaultMsg: '登录名由字母数字和下划线组成的4至25个字符'},
            ...
            {name: 'mail', validate: function(value) {if($.trim(value) != '')return (!/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(value));}, defaultMsg: '请输入正确的邮箱格式'},
            {name: 'char', validate: function(value) {return (!/^[a-z\_\-A-Z]*$/.test(value));}, defaultMsg: '请输入英文字符'},
            {name: 'mobile', validate: function(value) {if($.trim(value) != '')return (!/^1[34578]\d{9}$/.test(value));}, defaultMsg: '手机格式不正确'},
            ...
            {name: 'code', validate: function(value) {if($.trim(value) != '')return (!/^[0-9a-zA-Z]*$/g.test(value));}, defaultMsg: '格式有误，只能由数字、字母组成'},
            {name: 'name', validate: function(value) {if($.trim(value) != '')return (!/^[0-9a-zA-Zu4E00-\u9FA5]*$/g.test(value));}, defaultMsg: '格式有误，只能由数字、字母、中文组成'}
        ],
        reqmark:true,
